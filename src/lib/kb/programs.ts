...
export const PROGRAMS: Program[] = [
  ...
  },
  {
    ...
    name: "가족돌봄휴가",
    authority: "고용노동부",
    summary: "연간 10일까지 하루 단위로 쓸 수 있는 돌봄 휴가입니다. 시간 단위 분할은 노사 합의가 있어야 합니다.",
    plainSummary: "1년에 10일까지 하루씩 쉴 수 있습니다.",
    benefit: "연간 최대 10일. 가족돌봄휴직 90일에 포함. 시간 단위 분할 사용은 노사 합의 시 가능.",
    monthlyAmount: null,
    amountKind: "in-kind",
    applyAt: "재직 중인 사업장",
    ...
    caveat:
      "법정 한도는 연 10일입니다. 시간 단위로 쪼개 쓰는 것은 노사 합의를 전제하므로 회사 확인이 필요합니다. 2026년 확대 여부에 대한 상충되는 자료가 있어 시행 여부는 고용노동부에서 확인해야 합니다.",
